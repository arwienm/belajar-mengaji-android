...
public class HarokatKasrohActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton ButtonSuara11 = (ImageButton) this.findViewById(R.id.kasroh_za);
        ...
        ImageButton ButtonSuara25 = (ImageButton) this.findViewById(R.id.kasroh_nun);
        ImageButton ButtonSuara26 = (ImageButton) this.findViewById(R.id.kasroh_wi);
        ImageButton ButtonSuara27 = (ImageButton) this.findViewById(R.id.kasroh_haa);
