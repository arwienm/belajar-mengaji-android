...
public class HarokatFathahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton ButtonSuara10 = (ImageButton) this.findViewById(R.id.fatah_ro);
        ...
        ImageButton ButtonSuara14 = (ImageButton) this.findViewById(R.id.fatah_sho);
        ImageButton ButtonSuara15 = (ImageButton) this.findViewById(R.id.fatah_dho);
        ImageButton ButtonSuara16 = (ImageButton) this.findViewById(R.id.fatah_tho);
        ImageButton ButtonSuara17 = (ImageButton) this.findViewById(R.id.fatah_dzo);
        ImageButton ButtonSuara18 = (ImageButton) this.findViewById(R.id.fatah_aa);
        ImageButton ButtonSuara19 = (ImageButton) this.findViewById(R.id.fatah_gho);
        ImageButton ButtonSuara20 = (ImageButton) this.findViewById(R.id.fatah_fa);
        ImageButton ButtonSuara21 = (ImageButton) this.findViewById(R.id.fatah_qo);
        ImageButton ButtonSuara22 = (ImageButton) this.findViewById(R.id.fatah_ka);
        ImageButton ButtonSuara23 = (ImageButton) this.findViewById(R.id.fatah_lam);
        ImageButton ButtonSuara24 = (ImageButton) this.findViewById(R.id.fatah_mim);
        ImageButton ButtonSuara25 = (ImageButton) this.findViewById(R.id.fatah_nun);
